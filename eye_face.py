...
def generate_frames():
    while True:
        ...
        if not success:
            ...
            detector = cv2.CascadeClassifier('C:/Users/91868/OneDrive/Documents/Desktop/flask/Haarcascades/haarcascade_frontalface_default.xml')
            eye_cascade = cv2.CascadeClassifier('C:/Users/91868/OneDrive/Documents/Desktop/flask/Haarcascades/haarcascade_eye.xml')
